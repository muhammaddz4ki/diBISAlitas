      ...
      <div className="px-6 pt-12 pb-5">
        ...
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-2xl bg-[#00B894]/10 flex items-center justify-center">
            <GraduationCap className="w-6 h-6 text-[#00B894]" strokeWidth={2.4} />
          </div>
          <div>
            <h1 className="text-[22px] font-black text-slate-800 tracking-tight leading-none">Kamus Hijaiyah</h1>
            <p className="text-slate-400 text-[12px] font-semibold mt-1">
              29 huruf Hijaiyah · {learnedCount} dikuasai
            </p>
          </div>
        </div>
      </div>
        ...
        {HIJAIYAH_LABELS.map((l) => {
          ...
          return (
            <button
              ...
              className="relative bg-white border border-slate-100 rounded-3xl py-5 flex flex-col items-center shadow-[0_4px_16px_-10px_rgba(0,0,0,0.2)] active:scale-95 transition-transform"
            >
              <span className={`absolute top-2.5 right-2.5 w-2.5 h-2.5 rounded-full ${masteryStyle[m].dot}`} />
              <span
                className="text-[44px] leading-none text-[#0B0B0F] mb-1"
                style={{ fontFamily: "Arial, sans-serif" }}
              >
                {l.arabic}
              </span>
              <span className="text-[12px] font-bold text-slate-600">{l.indo}</span>
            </button>
          );
        })}
      </div>
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center">
                {showDemonstration ? (
                  <div className="w-32 h-32 sm:w-40 sm:h-40 bg-slate-100 rounded-2xl mb-4 mt-2 flex items-center justify-center overflow-hidden border-2 border-dashed border-slate-300">
                    <img
                  ...
                  <span
                    className="text-[110px] leading-none text-[#00B894] mb-2"
                    style={{ fontFamily: "Arial, sans-serif" }}
                  >
                    {selected.arabic}
                  </span>
                ...
                <div className="flex gap-2.5 mt-6 w-full">
                  <button
                    ...
                    className="flex-1 py-3.5 rounded-2xl bg-[#00B894]/10 text-[#00B894] font-bold text-[13px] flex items-center justify-center gap-2 active:scale-95 transition-transform"
                  >
                ...
                <Link
                  ...
                  className="mt-2.5 w-full py-3.5 rounded-2xl bg-[#00B894] text-white font-bold text-[14px] flex items-center justify-center gap-2 active:scale-95 transition-transform"
                >
