  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-purple-50/60 dark:from-black dark:to-purple-950/20 text-slate-800 dark:text-slate-200 selection:bg-purple-500/20">
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 relative overflow-visible">
        <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[400px] h-[200px]  bg-purple-500/10 dark:bg-purple-500/20  blur-3xl rounded-full pointer-events-none" />

        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center min-h-[60vh]">
            {/* Left: Info */}
            <div className="lg:col-span-7 space-y-6 relative z-10">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-purple-500/10 dark:bg-purple-500/20 border border-purple-500/20 dark:border-purple-500/30 text-purple-600 dark:text-purple-400 text-xs font-bold uppercase tracking-wider">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight text-slate-900 dark:text-white leading-[1.05]">
                BiBACA: Mendengar <br />
                <span className="text-purple-600 dark:text-purple-500">Setiap Tulisan</span> di Dunia Nyata
              </h1>
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                <Link
                  href="/app/bibaca"
                  className="px-8 py-4 rounded-full bg-purple-600 text-white font-extrabold text-sm hover:bg-purple-700 transition-all shadow-lg shadow-purple-600/20 flex items-center gap-2"
                >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-8 items-center min-h-[60vh]">
            <motion.div 
              ...
              style={{ perspective: "1200px" }}
            >
              <div className="absolute w-[40%] h-[60%]  bg-purple-500/10 dark:bg-purple-500/15  blur-[70px] rounded-full top-1/2 left-[40%] -translate-x-1/2 -translate-y-1/2" />
              <div 
                className="relative w-[270px] sm:w-[310px] lg:w-[340px] aspect-[9/18.5] mx-auto bg-slate-200 dark:bg-[#0a0a0a] rounded-[1.75rem] md:rounded-[2.25rem] border-[6px] md:border-[8px] border-slate-300 dark:border-[#1a1a1a] overflow-hidden flex flex-col items-center justify-center group transform-gpu preserve-3d transition-colors duration-300"
                style={{
                  transform: "rotateY(18deg) rotateX(5deg) rotateZ(-2deg)",
              ...
              >
                <span className="text-slate-400 dark:text-slate-600 font-medium text-xs text-center px-4">Screenshot: Pindai Dokumen BiBACA</span>
                <img src="/images/bibaca-screen1.jpg" alt="BiBACA OCR Scanner" className="absolute inset-0 w-full h-full object-cover" onError={(e) => (e.currentTarget.style.display = 'none')} />
                
                <div className="absolute inset-0 bg-gradient-to-br from-slate-100 via-slate-200 to-purple-500/20 dark:from-[#0a0e17] dark:via-[#111827] dark:to-purple-500/30 -z-10" />
                <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/5 to-transparent pointer-events-none" />
              </div>
            </motion.div>
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-black leading-[1.05] tracking-tight text-slate-900 dark:text-white">
                ...
                <em className="font-black italic text-purple-600 dark:text-purple-500">
                  Audio Berbahasa Indonesia.
                </em>
              </h2>
              <p className="text-slate-500 dark:text-white/70 text-sm md:text-[15px] leading-relaxed max-w-md font-light">
                Teknologi OCR canggih kami memindai buku, menu restoran, kemasan produk, dan dokumen lainnya hanya dengan sekali jepretan foto. Hasil teks akan diekstraksi dan dibacakan menggunakan sintesis suara (TTS) Bahasa Indonesia yang sangat natural, membantu Anda menyerap informasi visual tanpa kendala.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 text-center relative z-10 border-t border-slate-200 dark:border-white/5">
        <div className="max-w-3xl mx-auto space-y-8">
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 dark:text-white leading-[1.1]">
            Kemudahan Membaca Tanpa Mata
          </h2>
          <p className="text-slate-500 dark:text-slate-400 text-base md:text-lg">
            Rasakan langsung kemampuan BiBACA mengekstrak informasi tulisan fisik di sekitar Anda dalam hitungan detik.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/app/bibaca"
              className="px-8 py-4 rounded-full bg-purple-600 text-white font-extrabold text-sm hover:bg-purple-700 shadow-lg shadow-purple-600/20 hover:shadow-purple-600/40 transition-all"
            >
              Buka Scanner BiBACA
            </Link>
            <Link
