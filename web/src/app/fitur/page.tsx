...
const DETAILED_FEATURES = [
  {
    ...
    bgGlow: "bg-red-800/10 dark:bg-red-900/30",
    badgeBg: "bg-red-900/10 dark:bg-red-900/30",
    badgeBorder: "border-red-800/20 dark:border-red-800/40",
    badgeText: "text-red-800 dark:text-red-500",
    highlightText: "text-red-800 dark:text-red-600",
    buttonBg: "bg-red-800 hover:bg-red-900",
    buttonShadow: "shadow-red-900/30 hover:shadow-red-900/50",
    indicatorColor: "bg-red-500",
    tabActiveBg: "bg-slate-900 dark:bg-white text-white dark:text-slate-900",
    tabInactiveBg: "bg-white dark:bg-slate-900/50 text-slate-600 dark:text-slate-300 border-slate-200 dark:border-slate-800 hover:border-red-500/50",
    href: "/fitur/bisafe",
  },
  {
